...
MESSAGE_ERR_006='成立している日程は削除できません'
MESSAGE_ERR_007='開始日時が同じものは登録できません'
MESSAGE_ERR_SYSTEM='システムエラー'
MESSAGE_SCHEDULE_DELETE_SUCCESS='スケジュールが正常に削除されました'
MESSAGE_SCHEDULE_DELETE_FAILURE='スケジュールの削除に失敗しました'